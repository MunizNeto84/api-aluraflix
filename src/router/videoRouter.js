...
routers.get("/api/v1/video", authMiddleware, (req, res, next) =>
...
routers.get("/api/v1/video/:id", authMiddleware, (req, res, next) =>
  videoController.getById(req, res, next)
);
routers.post("/api/v1/video", authMiddleware, (req, res, next) =>
  videoController.create(req, res, next)
);
routers.patch("/api/v1/video/:id", authMiddleware, (req, res, next) =>
  videoController.edit(req, res, next)
);
routers.delete("/api/v1/video/:id", authMiddleware, (req, res, next) =>
